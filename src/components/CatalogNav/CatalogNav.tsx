...
const CatalogNav = () => {
  return (
    <div
      className="relative z-10 bg-white w-full max-w-full overflow-hidden
        before:content-[''] before:absolute before:top-0 before:inset-x-0 before:h-px before:bg-neutral-200
        after:content-[''] after:absolute after:bottom-0 after:inset-x-0 after:h-2 after:shadow-[0_4px_6px_-2px_rgba(0,0,0,0.15)] after:-z-10"
    >
      <div
        ...
        [-webkit-overflow-scrolling:touch] max-w-screen-xl mx-auto px-2"
        style={{
          scrollbarWidth: 'thin',
